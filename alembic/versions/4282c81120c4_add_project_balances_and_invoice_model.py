...
def upgrade() -> None:
    ...
    op.add_column(
        "projects",
        sa.Column("po_balance", sa.Float(), nullable=False, server_default="0.0"),
    )
    op.add_column(
        "projects",
        sa.Column(
            "estimated_balance", sa.Float(), nullable=False, server_default="0.0"
        ),
    )
    op.add_column(
        "projects",
    ...
    op.add_column(
        "projects", sa.Column("po_document_path", sa.String(255), nullable=True)
    )
    ...
    op.add_column(
        "project_balances",
        sa.Column(
            "balance_type", sa.String(20), nullable=False, server_default="actual"
        ),
    )
